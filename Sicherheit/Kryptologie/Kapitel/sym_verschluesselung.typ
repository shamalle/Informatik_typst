...
#exo(
  exercise: [
    ...
    [*Klartext*], [#highlight(fill: yellow)[1]#highlight(fill: rgb("A7F3E0"))[0]#highlight(fill: rgb("F9A8D4"))[0]1000], [1000001], [1001100], [1001100], [1001111], 
    
    [*Schlüssel*], [#highlight(fill: yellow)[1]#highlight(fill: rgb("A7F3E0"))[0]#highlight(fill: rgb("F9A8D4"))[1]0110], [1000101], [1001100], [1001111], [0110010],
...
#grid( columns: (2.8fr, 2fr),
  ...
  [
    ...
    [*Schlüssel*], [J], [A], table.cell(fill: rgb("D3D3D3"))[], table.cell(fill: rgb("D3D3D3"))[], table.cell(fill: rgb("D3D3D3"))[],

    [*ASCII*], [1001010], [1000001], table.cell(fill: rgb("D3D3D3"))[], table.cell(fill: rgb("D3D3D3"))[], table.cell(fill: rgb("D3D3D3"))[])
    ],
    [
      #v(2pt)
